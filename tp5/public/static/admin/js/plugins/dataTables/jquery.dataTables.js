...
(/** @lends <global> */function( $ ) {
	...
	function _fnCompatOpts ( init )
	{
		...
		_fnCompatMap( init, 'index.html',         'aaSorting' );
		...
		this.each(function() {
			...
			if ( rowOne.length ) {
				...
				$.each( _fnGetRowElements( oSettings, rowOne[0] ).cells, function (i, cell) {
					...
					if ( col.mData === i ) {
						var sort = a( cell, 'sort' ) || a( cell, 'index.html' );
			...
			if ( oSettings.oFeatures.bSort )
			{
				_fnCallbackReg( oSettings, 'aoDrawCallback', function () {
					if ( oSettings.bSorted ) {
						...
						_fnCallbackFire( oSettings, null, 'index.html', [oSettings, aSort, sortedColumns] );
						_fnSortingClasses( oSettings );
	 ...
	 * @returns {DataTables.Api} this
	 */
	_api_register( 'index.html.listener()', function (node, column, callback ) {
		return this.iterator( 'table', function ( settings ) {
	...
	$.extend( true, DataTable.ext.renderer, {
		header: {
			_: function ( settings, cell, column, idx, classes ) {
				...
				$(settings.nTable).on( 'index.html.dt', function (e, settings, sorting, columns ) {
					cell
						.removeClass(
